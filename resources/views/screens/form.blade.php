...
@section('content')
    ...
    <form method="POST" action="{{ $screen->exists ? route('screens.update', $screen->id) : route('screens.store')  }}">
        ...
        <div class="form-group">
            ...
            <input id="name" name="name" type="text" required autofocus value="{{ $screen->name or old('name') }}" placeholder="e.g. 'Kitchen Planner'" class="form-control">
        </div>
        ...
        <div class="form-group">
            ...
            <input id="code" name="code" type="text" required autofocus value="{{ $screen->code or old('code') }}" placeholder="e.g. '5DE20LK09'" class="form-control">
        </div>
        ...
        <div class="form-group">
            ...
            <p class="help-block">
                Select the type of screen. Currently only 2 modes are supported. Normal is the default, mirror is a high contrast theme to build into mirrors.
            </p>
